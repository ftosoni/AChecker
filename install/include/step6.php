...
<br />
	...
	<tr>
		<td class="row1" colspan="2">Submit the following information to the achecker.ca server anonymously? The information we gather helps us plan our development resources to better suit the needs of the community. You may optionally choose to send the URL of your AChecker installation.</td>
	</tr>
	<tr>
		<td class="row1" width="20%"><b>AChecker Version:</b></td>
	...
	<tr>
		...
		<td class="row1"><?php
			...
			if ($_POST['step1']['old_path'] != '') {
				...
				$db     = mysqli_connect($_POST['step2']['db_host'], $_POST['step2']['db_login'], $_POST['step2']['db_password'], $_POST['step2']['db_name'], $_POST['step2']['db_port']);
			}
